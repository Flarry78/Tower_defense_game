...
@onready var bild: Sprite2D = $bild
@onready var reload: Timer = $reload
@onready var bullet = preload("res://geschosse/fleischbullet.tscn")
...
func basestats() -> void:
	...
	schaden = Base.basictower.Fleischtower.schaden
	feuerrate = Base.basictower.Fleischtower.feuerrate
	maxrange = Base.basictower.Fleischtower.maxrange
