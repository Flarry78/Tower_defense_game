...
@onready var bullet = preload("res://geschosse/bullet.tscn")
...
func basestats() -> void:
	...
	schaden = Base.basictower.Basetower.schaden
	feuerrate = Base.basictower.Basetower.feuerrate
	maxrange = Base.basictower.Basetower.maxrange
